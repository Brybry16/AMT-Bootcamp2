...
public class IdFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(id == null){
            ...
            //res.sendRedirect(req.getContextPath() + "/WEB-INF/pages/Login.jsp");
            req.getRequestDispatcher("/WEB-INF/pages/Login.jsp").forward(request, response);
            //req.getRequestDispatcher("web.LoginServelet.java").forward(request, response);
        }
        else{
            log("IdFilter:doFilter():LOGIN");
            req.getRequestDispatcher("/WEB-INF/pages/Home.jsp").forward(request, response);
        }
